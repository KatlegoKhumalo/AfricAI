...
const generateMockUsers = (): User[] => {
    ...
    return [mockLearnerUser, ...tutorsAsUsers, ...learners];
}
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-4">
                     <div className="relative">
                        <input type="text" placeholder="Search users..." className="bg-white/5 border border-white/10 rounded-md py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-nebula-600 focus:outline-none" />
                        <SearchIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                    </div>
                </div>
            </div>
            
            <Table title="All Users" headers={tableHeaders} data={tableData} />
