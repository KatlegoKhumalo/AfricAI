                    ...
                    <>
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-nebula-700 to-nebula-500 mt-2">${course.price.toFixed(2)}</p>
                            </div>
                        </div>
                        ...
                        <PaymentForm 
                            ...
                            submitButtonText={`Pay $${course.price.toFixed(2)}`}
                        />
                    </>
                )}
            </GlassCard>
