            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-20">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        <NavLink to="/courses" className={({ isActive }) => isActive ? `${navLinkClassName} ${activeClassName}` : navLinkClassName}>All Courses</NavLink>
                        <NavLink to="/tutors" className={({ isActive }) => isActive ? `${navLinkClassName} ${activeClassName}` : navLinkClassName}>Find a Tutor</NavLink>
                        <NavLink to="/ai-tutor" className={({ isActive }) => isActive ? `${navLinkClassName} ${activeClassName}` : navLinkClassName}>AI Tutor</NavLink>
                        <NavLink to="/cai" className={({ isActive }) => isActive ? `${navLinkClassName} ${activeClassName}` : navLinkClassName}>CAI</NavLink>
                    </nav>
